...
final class PaymentRecorder
{
     ...
     */
    public function recordValidation(User $merchant, PaymentValidationData $validation): Payment
    {
     ...
     */
    public function recordNotification(User $merchant, PaymentNotificationData $notification): ?Payment
    {
